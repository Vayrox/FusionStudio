...
So for N fusions the total is: 1 opener + (N * 1 'merges with' line) + (N * 1 description block of 1-2 sentences) + 1 CTA. No additional intro / transition / filler sentences between fusions.
